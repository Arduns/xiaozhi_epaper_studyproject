...
void LcdDisplay::SetupUI() {
    ...
    /* Bottom bar - fixed height for 2 lines of wrapped text at the bottom */
    bottom_bar_ = lv_obj_create(screen);
    lv_obj_set_width(bottom_bar_, LV_HOR_RES);
    lv_obj_set_height(bottom_bar_, text_font->line_height * 2 + lvgl_theme->spacing(8));
    ...
    /* chat_message_label_ placed in bottom_bar_, wrapped 2-line display with ellipsis */
